...
<div class="project-illustration-scene">
  <svg width="100%" viewBox="58 18 524 432" xmlns="http://www.w3.org/2000/svg">
    ...
    <g class="anim-a">
      ...
      <text class="mono" x="115" y="38" text-anchor="middle" font-size="10" fill="#3B82F6" letter-spacing=".1em">GITHUB</text>
      <text class="sans" x="115" y="54" text-anchor="middle" font-size="11" fill="#CCC" font-weight="400">git push</text>
    </g>
    <g class="anim-a">
      <rect x="200" y="20" width="110" height="44" rx="6" fill="#0E0E0E" stroke="#252525" stroke-width="1"/>
      <text class="mono" x="255" y="38" text-anchor="middle" font-size="10" fill="#555" letter-spacing=".1em">PR PREVIEW</text>
      <text class="sans" x="255" y="54" text-anchor="middle" font-size="11" fill="#888" font-weight="400">pr-42</text>
    </g>
    ...
    <g class="anim-a">
      ...
      <text class="mono" x="80" y="113" font-size="10" fill="#1E40AF" letter-spacing=".1em">CONTROL PLANE</text>
      <rect x="80" y="120" width="60" height="20" rx="3" fill="#111" stroke="#222" stroke-width=".5"/>
      <text class="mono" x="110" y="133" text-anchor="middle" font-size="10" fill="#555">Next.js</text>
      <rect x="148" y="120" width="56" height="20" rx="3" fill="#111" stroke="#222" stroke-width=".5"/>
      <text class="mono" x="176" y="133" text-anchor="middle" font-size="10" fill="#555">Web UI</text>
      <rect x="212" y="120" width="68" height="20" rx="3" fill="#111" stroke="#222" stroke-width=".5"/>
      <text class="mono" x="246" y="133" text-anchor="middle" font-size="10" fill="#555">REST API</text>
      <rect x="472" y="120" width="92" height="20" rx="3" fill="#0D1117" stroke="#1E3A5F" stroke-width=".5"/>
      <text class="mono" x="518" y="133" text-anchor="middle" font-size="10" fill="#2563EB">PostgreSQL</text>
    </g>
    ...
    <g class="anim-a">
      ...
      <text class="mono" x="80" y="197" font-size="10" fill="#15803D" letter-spacing=".1em">WORKER - NODE.JS</text>
      <rect x="80" y="203" width="52" height="22" rx="3" fill="#111" stroke="#1A1A1A" stroke-width=".5"/>
      <text class="mono" x="106" y="217" text-anchor="middle" font-size="10" fill="#666">build</text>
      <rect x="140" y="203" width="52" height="22" rx="3" fill="#111" stroke="#1A1A1A" stroke-width=".5"/>
      <text class="mono" x="166" y="217" text-anchor="middle" font-size="10" fill="#666">deploy</text>
      <rect x="200" y="203" width="52" height="22" rx="3" fill="#111" stroke="#1A1A1A" stroke-width=".5"/>
      <text class="mono" x="226" y="217" text-anchor="middle" font-size="10" fill="#666">provision</text>
      <rect x="260" y="203" width="60" height="22" rx="3" fill="#0A2A12" stroke="#15803D" stroke-width=".8"/>
      <text class="mono" x="290" y="217" text-anchor="middle" font-size="10" fill="#4ADE80">run</text>
      <text class="mono" x="360" y="217" text-anchor="end" font-size="10" fill="#2A2A2A">BullMQ</text>
    </g>
    <g class="anim-a">
      <rect x="456" y="178" width="124" height="56" rx="8" fill="#0B0B0B" stroke="#1C1C1C" stroke-width="1"/>
      <text class="mono" x="518" y="197" text-anchor="middle" font-size="10" fill="#7F1D1D" letter-spacing=".1em">REDIS</text>
    ...
    <g class="anim-a">
      ...
      <text class="mono" x="80" y="285" font-size="10" fill="#1E40AF" letter-spacing=".1em">DOCKER ENGINE</text>
      <rect x="80" y="292" width="80" height="44" rx="5" fill="#0D0D0D" stroke="#1C1C1C" stroke-width=".8"/>
      <text class="mono" x="120" y="309" text-anchor="middle" font-size="10" fill="#3B82F6">app</text>
      <text class="mono" x="120" y="325" text-anchor="middle" font-size="10" fill="#333">Node.js</text>
      <rect x="168" y="292" width="108" height="44" rx="5" fill="#071A0E" stroke="#15803D" stroke-width=".8"/>
      <text class="mono" x="222" y="309" text-anchor="middle" font-size="10" fill="#4ADE80">preview/pr-42</text>
      <text class="mono" x="222" y="325" text-anchor="middle" font-size="10" fill="#15803D">auto-deploy</text>
      <rect x="284" y="292" width="72" height="44" rx="5" fill="#0D0D0D" stroke="#1C1C1C" stroke-width=".8"/>
      <text class="mono" x="320" y="309" text-anchor="middle" font-size="10" fill="#666">postgres</text>
      <text class="mono" x="320" y="325" text-anchor="middle" font-size="10" fill="#2A2A2A">managed</text>
      <rect x="364" y="292" width="60" height="44" rx="5" fill="#0D0D0D" stroke="#1C1C1C" stroke-width=".8"/>
      <text class="mono" x="394" y="309" text-anchor="middle" font-size="10" fill="#666">redis</text>
      <text class="mono" x="394" y="325" text-anchor="middle" font-size="10" fill="#2A2A2A">managed</text>
      <rect x="432" y="292" width="56" height="44" rx="5" fill="#0D0D0D" stroke="#1C1C1C" stroke-width=".8"/>
      <text class="mono" x="460" y="309" text-anchor="middle" font-size="10" fill="#666">minio</text>
      <text class="mono" x="460" y="325" text-anchor="middle" font-size="10" fill="#2A2A2A">S3-compat</text>
      <rect x="496" y="292" width="68" height="44" rx="5" fill="#0D0D0D" stroke="#1C1C1C" stroke-width=".8"/>
      <text class="mono" x="530" y="309" text-anchor="middle" font-size="10" fill="#666">mysql</text>
      <text class="mono" x="530" y="325" text-anchor="middle" font-size="10" fill="#2A2A2A">managed</text>
    </g>
    ...
    <g class="anim-a">
      ...
      <text class="mono" x="320" y="394" text-anchor="middle" font-size="10" fill="#4F46E5" letter-spacing=".04em">Traefik v3 - auto SSL - subdomain routing - reverse proxy</text>
    </g>
    ...
    <g class="anim-a">
      ...
      <text class="mono" x="142" y="436" text-anchor="middle" font-size="10" fill="#333">Prometheus</text>
      <rect x="232" y="418" width="116" height="30" rx="5" fill="#0A0A0A" stroke="#1A1A1A" stroke-width=".5"/>
      <text class="mono" x="290" y="436" text-anchor="middle" font-size="10" fill="#333">Loki</text>
      <rect x="356" y="418" width="224" height="30" rx="5" fill="#0A0A0A" stroke="#C2410C" stroke-width=".5" opacity=".9"/>
      <text class="mono" x="468" y="436" text-anchor="middle" font-size="10" fill="#EA580C">Grafana</text>
    </g>
  </svg>
</div>`,
      }}
...
<div class="project-illustration-scene">
  <svg width="100%" viewBox="30 38 576 324" xmlns="http://www.w3.org/2000/svg">
    ...
    <g class="col">
      ...
      <text class="mono" x="106" y="54" text-anchor="middle" font-size="10" fill="#333">yourapp.com</text>
      ...
      <text class="mono" x="106" y="86" text-anchor="middle" font-size="10" fill="#333" letter-spacing=".1em">REACT APP</text>
      <rect x="46" y="96" width="120" height="38" rx="4" fill="#0A1628" stroke="#1E3A5F" stroke-width=".8"/>
      <text class="mono" x="106" y="112" text-anchor="middle" font-size="11" fill="#3B82F6">usePaynow()</text>
      <text class="sans" x="106" y="127" text-anchor="middle" font-size="10" fill="#1E40AF">React hook</text>
      <rect x="46" y="144" width="120" height="34" rx="4" fill="#0D0D0D" stroke="#1E1E1E" stroke-width=".8"/>
      <text class="mono" x="56" y="159" font-size="10" fill="#444">amount</text>
      <text class="sans" x="106" y="172" text-anchor="middle" font-size="12" fill="#E5E5E5" font-weight="400">$25.00 USD</text>
      <rect x="46" y="188" width="120" height="34" rx="5" fill="#15803D" stroke="#166534" stroke-width=".8"/>
      <text class="sans" x="106" y="209" text-anchor="middle" font-size="11" fill="#FFF" font-weight="400">Pay with Paynow</text>
      <rect x="46" y="232" width="120" height="26" rx="4" fill="#051A0A" stroke="#15803D" stroke-width=".5"/>
      <text class="mono" x="106" y="248" text-anchor="middle" font-size="10" fill="#4ADE80">polling for status...</text>
      <rect x="46" y="268" width="120" height="30" rx="4" fill="#0A0A0A" stroke="#1A1A1A" stroke-width=".5"/>
      <text class="mono" x="56" y="282" font-size="10" fill="#333">returnUrl</text>
      <text class="mono" x="56" y="295" font-size="10" fill="#555">yourapp.com/return</text>
      <g class="tick">
      ...
      <text class="mono" x="106" y="360" text-anchor="middle" font-size="10" fill="#15803D">paid</text>
    </g>
    ...
    <text class="mono" x="204" y="129" text-anchor="middle" font-size="10" fill="#1E40AF">initiate</text>
    <text class="mono" x="204" y="170" text-anchor="middle" font-size="10" fill="#15803D">redirect</text>

    <g class="col">
      <rect x="230" y="40" width="172" height="274" rx="8" fill="#090909" stroke="#1E1E1E" stroke-width=".8"/>
      <text class="mono" x="316" y="66" text-anchor="middle" font-size="10" fill="#333" letter-spacing=".1em">PAYNOW API</text>
      <rect x="246" y="78" width="140" height="38" rx="4" fill="#0A0A0A" stroke="#1A1A1A" stroke-width=".5"/>
      <text class="mono" x="316" y="94" text-anchor="middle" font-size="10" fill="#555">POST /initiate</text>
      <text class="sans" x="316" y="109" text-anchor="middle" font-size="10" fill="#333">Create session</text>
      ...
      <text class="mono" x="316" y="148" text-anchor="middle" font-size="10" fill="#555">GET /status</text>
      <text class="sans" x="316" y="163" text-anchor="middle" font-size="10" fill="#333">Poll until settled</text>
      ...
      <text class="mono" x="316" y="202" text-anchor="middle" font-size="10" fill="#555">resultUrl webhook</text>
      <text class="sans" x="316" y="217" text-anchor="middle" font-size="10" fill="#333">Server confirmation</text>
      ...
      <text class="mono" x="278" y="253" text-anchor="middle" font-size="10" fill="#2563EB">TypeScript</text>
      <rect x="318" y="240" width="68" height="20" rx="3" fill="#0A0A0A" stroke="#1A1A1A" stroke-width=".5"/>
      <text class="mono" x="352" y="253" text-anchor="middle" font-size="10" fill="#333">open source</text>
      <rect x="246" y="270" width="140" height="28" rx="4" fill="#051A0A" stroke="#15803D" stroke-width=".5"/>
      <g class="gp">
        <circle cx="260" cy="284" r="3" fill="#4ADE80"/>
      </g>
      <text class="mono" x="316" y="288" text-anchor="middle" font-size="10" fill="#15803D">auto-polling active</text>
    </g>
    ...
    <g class="col">
      ...
      <text class="mono" x="518" y="116" text-anchor="middle" font-size="10" fill="#4ADE80" letter-spacing=".1em">ECOCASH</text>
      <text class="sans" x="518" y="133" text-anchor="middle" font-size="10" fill="#15803D">Mobile money / ZWL USD</text>
      ...
      <text class="mono" x="518" y="190" text-anchor="middle" font-size="10" fill="#3B82F6" letter-spacing=".1em">ONEMONEY</text>
      <text class="sans" x="518" y="207" text-anchor="middle" font-size="10" fill="#1E40AF">Mobile money / ZWL USD</text>
      <rect x="432" y="238" width="172" height="64" rx="7" fill="#0A0A0A" stroke="#222" stroke-width=".8"/>
      <text class="mono" x="518" y="264" text-anchor="middle" font-size="10" fill="#444" letter-spacing=".1em">WEB CHECKOUT</text>
      <text class="sans" x="518" y="281" text-anchor="middle" font-size="10" fill="#333">Redirect / card / bank</text>
    </g>
  </svg>
</div>`,
      }}
